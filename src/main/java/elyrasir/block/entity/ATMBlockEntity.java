...
public class ATMBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public ATMBlockEntity(BlockPos position, BlockState state) {
		super(ElyrasirModBlockEntities.ATM.get(), position, state);
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new BaseAtmMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}
