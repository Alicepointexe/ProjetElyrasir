...
public class CapCoordDeleteProcedure {
	public static void execute(CommandContext<CommandSourceStack> arguments, Entity entity) {
		...
		if (file.exists()) {
			{
				try {
					...
					coords = objetprincipale.get("Coords").getAsJsonObject();
		...
		if (entity instanceof Player _player && !_player.level().isClientSide())
			_player.displayClientMessage(Component.literal("coords suprim\u00E9s"), true);
	}
}
