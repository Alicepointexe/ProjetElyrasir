...
import elyrasir.procedures.IdentityrightclickProcedure;

import elyrasir.item.inventory.IdentityInventoryCapability;

public class IdentityItem extends Item {
	public IdentityItem() {
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		if (entity instanceof ServerPlayer serverPlayer) {
			NetworkHooks.openScreen(serverPlayer, new MenuProvider() {
				...
				public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
					...
					return new IdentityguiMenu(id, inventory, packetBuffer);
				}
			}, buf -> {
		...
		IdentityrightclickProcedure.execute(world, entity.getX(), entity.getY(), entity.getZ(), entity, ar.getObject());
		return ar;
	}

	@Override
	public ICapabilityProvider initCapabilities(ItemStack stack, @Nullable CompoundTag compound) {
		return new IdentityInventoryCapability();
	}
