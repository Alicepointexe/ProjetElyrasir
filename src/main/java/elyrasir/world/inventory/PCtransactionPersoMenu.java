...
public class PCtransactionPersoMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public PCtransactionPersoMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(ElyrasirModMenus.P_CTRANSACTION_PERSO.get(), id);
