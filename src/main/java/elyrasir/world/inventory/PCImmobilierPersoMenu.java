...
public class PCImmobilierPersoMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public PCImmobilierPersoMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(ElyrasirModMenus.PC_IMMOBILIER_PERSO.get(), id);
