...
public class BasepAcountATMMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public BasepAcountATMMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(ElyrasirModMenus.BASEP_ACOUNT_ATM.get(), id);
