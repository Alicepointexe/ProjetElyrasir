...
public class PCcreditsPersoMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public PCcreditsPersoMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(ElyrasirModMenus.P_CCREDITS_PERSO.get(), id);
