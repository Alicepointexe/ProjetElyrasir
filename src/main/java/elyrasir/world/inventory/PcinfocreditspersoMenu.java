...
public class PcinfocreditspersoMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public PcinfocreditspersoMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(ElyrasirModMenus.PCINFOCREDITSPERSO.get(), id);
