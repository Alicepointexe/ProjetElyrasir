...
public class PCVentepcPersoMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public PCVentepcPersoMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(ElyrasirModMenus.PC_VENTEPC_PERSO.get(), id);
