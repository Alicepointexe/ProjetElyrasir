...
public class PCobtCreditPersoMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public PCobtCreditPersoMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(ElyrasirModMenus.P_COBT_CREDIT_PERSO.get(), id);
