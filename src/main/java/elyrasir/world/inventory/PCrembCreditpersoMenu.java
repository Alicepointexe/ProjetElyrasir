...
public class PCrembCreditpersoMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public PCrembCreditpersoMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(ElyrasirModMenus.P_CREMB_CREDITPERSO.get(), id);
