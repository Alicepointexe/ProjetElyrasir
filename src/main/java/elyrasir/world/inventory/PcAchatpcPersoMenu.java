...
public class PcAchatpcPersoMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public PcAchatpcPersoMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(ElyrasirModMenus.PC_ACHATPC_PERSO.get(), id);
