...
public class PCBasePersoMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public PCBasePersoMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(ElyrasirModMenus.PC_BASE_PERSO.get(), id);
