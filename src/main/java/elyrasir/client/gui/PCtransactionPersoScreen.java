...
import elyrasir.network.PCtransactionPersoButtonMessage;

import elyrasir.ElyrasirMod;

import com.mojang.blaze3d.systems.RenderSystem;

public class PCtransactionPersoScreen extends AbstractContainerScreen<PCtransactionPersoMenu> {
	private final static HashMap<String, Object> guistate = PCtransactionPersoMenu.guistate;
	...
	public PCtransactionPersoScreen(PCtransactionPersoMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("elyrasir:textures/screens/p_ctransaction_perso.png");
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.elyrasir.p_ctransaction_perso.label_bienvenue_a_la_banque"), 56, 15, -16777216, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.elyrasir.p_ctransaction_perso.label_veuillez_choisir_une_service"), 37, 24, -16777216, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.elyrasir.p_ctransaction_perso.label_acheter_du_pommecoin"), 43, 42, -3355444, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.elyrasir.p_ctransaction_perso.label_quitter"), 111, 108, -52429, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.elyrasir.p_ctransaction_perso.label_1"), 178, 41, -16777216, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.elyrasir.p_ctransaction_perso.label_11"), 212, 17, -16777216, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.elyrasir.p_ctransaction_perso.label_2"), 178, 56, -16777216, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.elyrasir.p_ctransaction_perso.label_5"), 178, 108, -16777216, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.elyrasir.p_ctransaction_perso.label_21"), 212, 40, -16777216, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.elyrasir.p_ctransaction_perso.label_31"), 212, 63, -16777216, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.elyrasir.p_ctransaction_perso.label_41"), 212, 86, -16777216, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.elyrasir.p_ctransaction_perso.label_51"), 213, 109, -16777216, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.elyrasir.p_ctransaction_perso.label_reserver_une_chambre"), 43, 56, -1, false);
	}
	...
	public void init() {
		...
		imagebutton_round_button_vanilla = new ImageButton(this.leftPos + 205, this.topPos + 12, 20, 20, 0, 0, 20, new ResourceLocation("elyrasir:textures/screens/atlas/imagebutton_round_button_vanilla.png"), 20, 40, e -> {
			if (true) {
				ElyrasirMod.PACKET_HANDLER.sendToServer(new PCtransactionPersoButtonMessage(0, x, y, z));
				PCtransactionPersoButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
		});
		...
		imagebutton_round_button_vanilla1 = new ImageButton(this.leftPos + 205, this.topPos + 35, 20, 20, 0, 0, 20, new ResourceLocation("elyrasir:textures/screens/atlas/imagebutton_round_button_vanilla1.png"), 20, 40, e -> {
			if (true) {
				ElyrasirMod.PACKET_HANDLER.sendToServer(new PCtransactionPersoButtonMessage(1, x, y, z));
				PCtransactionPersoButtonMessage.handleButtonAction(entity, 1, x, y, z);
			}
		});
		...
		imagebutton_round_button_vanilla4 = new ImageButton(this.leftPos + 205, this.topPos + 104, 20, 20, 0, 0, 20, new ResourceLocation("elyrasir:textures/screens/atlas/imagebutton_round_button_vanilla4.png"), 20, 40, e -> {
			if (true) {
				ElyrasirMod.PACKET_HANDLER.sendToServer(new PCtransactionPersoButtonMessage(4, x, y, z));
				PCtransactionPersoButtonMessage.handleButtonAction(entity, 4, x, y, z);
			}
		});
