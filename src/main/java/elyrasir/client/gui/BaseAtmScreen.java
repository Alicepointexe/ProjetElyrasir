...
import elyrasir.network.BaseAtmButtonMessage;

import elyrasir.ElyrasirMod;

import com.mojang.blaze3d.systems.RenderSystem;

public class BaseAtmScreen extends AbstractContainerScreen<BaseAtmMenu> {
	private final static HashMap<String, Object> guistate = BaseAtmMenu.guistate;
	...
	public BaseAtmScreen(BaseAtmMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("elyrasir:textures/screens/base_atm.png");
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		...
		guiGraphics.drawString(this.font, Component.translatable("gui.elyrasir.base_atm.label_11"), 212, 17, -16777216, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.elyrasir.base_atm.label_2"), 178, 56, -16777216, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.elyrasir.base_atm.label_3"), 178, 72, -16777216, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.elyrasir.base_atm.label_4"), 178, 87, -16777216, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.elyrasir.base_atm.label_5"), 178, 108, -16777216, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.elyrasir.base_atm.label_21"), 212, 40, -16777216, false);
	...
	public void init() {
		...
		imagebutton_round_button_vanilla4 = new ImageButton(this.leftPos + 205, this.topPos + 104, 20, 20, 0, 0, 20, new ResourceLocation("elyrasir:textures/screens/atlas/imagebutton_round_button_vanilla4.png"), 20, 40, e -> {
			if (true) {
				ElyrasirMod.PACKET_HANDLER.sendToServer(new BaseAtmButtonMessage(4, x, y, z));
				BaseAtmButtonMessage.handleButtonAction(entity, 4, x, y, z);
			}
		});
